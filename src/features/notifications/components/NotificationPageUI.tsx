...
export default function NotificationPageUI({
  ...
  const paymentCount = notifications.filter(
    (notification) => notification.category === NotificationCategory.PAYMENT,
  ).length;

  const reviewCount = notifications.filter(
    (notification) => notification.category === NotificationCategory.REVIEW,
  ).length;

  const infoCount = notifications.filter(
    (notification) => notification.category === NotificationCategory.INFO,
  ).length;

  const systemCount = notifications.filter(
    (notification) => notification.category === NotificationCategory.SYSTEM,
  ).length;
