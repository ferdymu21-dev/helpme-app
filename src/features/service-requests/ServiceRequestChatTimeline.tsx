...
export default function ServiceRequestChatTimeline({
  ...
  const timeline = buildTimeline(messages, agreements);
          ...
          >
            <div
              className={`
                ${
                  variant === "mobile"
                    ? "max-w-[82%] rounded-2xl px-3.5 py-2.5 text-[14px]"
              ...
              >
                <p
                  className={`
                    ...
                    ${variant === "mobile" ? "leading-5" : "leading-6"}
                  `}
                >
                ...
                <time
                  ...
                  `}
                >
                  {formatChatMessageTime(item.message.created_at)}
                </time>
              </div>
            </div>
          </div>
